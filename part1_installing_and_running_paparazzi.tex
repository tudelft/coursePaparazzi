...
We recommend you install Ubuntu 22.04.1 \url{https://www.ubuntu.com/download/desktop}. The rest of the course manuals assume that you are running Ubuntu 22.04.1. 

\textbf{NOTE} Ubuntu 24.04 can be used for flying but Gazebo is not yet supported!
