...
\textbf{NOTE} Ubuntu 24.04 can be used for flying but Gazebo (the simulator) is not yet supported!
...
\begin{enumerate}
	...
	\item Now install Paparazzi by running the instal script in Ubuntu 22 or 24:
	\begin{lstlisting}[style=Bash]
		./install.sh
	\end{lstlisting}

	For Ubuntu 20.04 or earlier, run the following command to install Paparazzi:
